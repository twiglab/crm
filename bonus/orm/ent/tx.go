...
func (tx *Tx) init() {
	tx.BonusAcc = NewBonusAccClient(tx.config)
	tx.BonusItem = NewBonusItemClient(tx.config)
}
...
// applies a query, for example: BonusAcc.QueryXXX(), the query will be executed
