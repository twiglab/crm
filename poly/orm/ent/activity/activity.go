...
const (
	...
	// FieldActivityApproveTime holds the string denoting the activity_approve_time field in the database.
	FieldActivityApproveTime = "activity_approve_time"
...
// ByActivityApproveTime orders the results by the activity_approve_time field.
func ByActivityApproveTime(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldActivityApproveTime, opts...).ToFunc()
}
