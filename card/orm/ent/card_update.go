...
func (cu *CardUpdate) SetBalance(i int) *CardUpdate {
...
func (cu *CardUpdate) SetNillableBalance(i *int) *CardUpdate {
	if i != nil {
		cu.SetBalance(*i)
	}
	return cu
...
func (cu *CardUpdate) AddBalance(i int) *CardUpdate {
	cu.mutation.AddBalance(i)
	return cu
}

// SetAmount sets the "amount" field.
func (cu *CardUpdate) SetAmount(i int) *CardUpdate {
...
func (cu *CardUpdate) SetNillableAmount(i *int) *CardUpdate {
	if i != nil {
		cu.SetAmount(*i)
	}
	return cu
...
func (cu *CardUpdate) AddAmount(i int) *CardUpdate {
...
func (cu *CardUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.AddedBalance(); ok {
		_spec.AddField(card.FieldBalance, field.TypeInt, value)
	}
	...
	if value, ok := cu.mutation.AddedAmount(); ok {
		_spec.AddField(card.FieldAmount, field.TypeInt, value)
	}
...
// SetBalance sets the "balance" field.
func (cuo *CardUpdateOne) SetBalance(i int) *CardUpdateOne {
...
// SetNillableBalance sets the "balance" field if the given value is not nil.
func (cuo *CardUpdateOne) SetNillableBalance(i *int) *CardUpdateOne {
	if i != nil {
		cuo.SetBalance(*i)
	}
	return cuo
...
// AddBalance adds i to the "balance" field.
func (cuo *CardUpdateOne) AddBalance(i int) *CardUpdateOne {
	cuo.mutation.AddBalance(i)
	return cuo
}

// SetAmount sets the "amount" field.
func (cuo *CardUpdateOne) SetAmount(i int) *CardUpdateOne {
...
// SetNillableAmount sets the "amount" field if the given value is not nil.
func (cuo *CardUpdateOne) SetNillableAmount(i *int) *CardUpdateOne {
	if i != nil {
		cuo.SetAmount(*i)
	}
	return cuo
...
// AddAmount adds i to the "amount" field.
func (cuo *CardUpdateOne) AddAmount(i int) *CardUpdateOne {
